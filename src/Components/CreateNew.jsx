          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <label htmlFor="agree-terms" className="text-sm text-gray-600">
                ...
                <button className="text-red-500 hover:text-red-600 font-medium">Terms of Service</button>
                ,{' '}
                <button className="text-red-500 hover:text-red-600 font-medium">Privacy Policy</button>
                {' '}and{' '}
                <button className="text-red-500 hover:text-red-600 font-medium">Content Policies</button>
              </label>
            </div>
