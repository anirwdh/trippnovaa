      ...
      <div className="max-w-[1300px] mx-auto flex flex-wrap gap-10 justify-between">
        ...
        <div className="flex flex-col gap-4 items-end min-w-[180px] mb-8">
          <div className="flex gap-4">
            <button className="flex items-center gap-2 border border-gray-300 rounded px-3 py-1 bg-white text-gray-700 font-medium text-xs">
              <span className="fi fi-in"></span>
              India
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3 h-3 ml-1 text-gray-500">
