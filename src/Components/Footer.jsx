...
function Footer() {
  return (
    <footer className="bg-gray-50 border-t border-gray-200 mt-12 px-4 pt-12 pb-6 text-zinc-900 text-base">
      <div className="max-w-[1300px] mx-auto flex flex-wrap gap-10 justify-between">
        {/* Logo and About */}
        <div className="min-w-[180px] mb-8">
          <div className="flex items-center gap-2 mb-6">
            <span className="text-3xl font-extrabold tracking-tight">trippnova</span>
          </div>
          <div className="font-bold mb-3 uppercase tracking-wide text-sm">About Trippnova</div>
          <div className="text-zinc-700 mb-1.5">Who We Are</div>
          <div className="text-zinc-700 mb-1.5">Blog</div>
          <div className="text-zinc-700 mb-1.5">Contact Us</div>
        </div>
        {/* For Agencies */}
        <div className="min-w-[180px] mb-8">
          <div className="font-bold mb-3 uppercase tracking-wide text-sm">For Agencies</div>
          <div className="text-zinc-700 mb-1.5">Partner With Us</div>
          <div className="text-zinc-700 mb-1.5">Add Agency</div>
        </div>
        {/* Learn More */}
        <div className="min-w-[180px] mb-8">
          <div className="font-bold mb-3 uppercase tracking-wide text-sm">Learn More</div>
          <div className="text-zinc-700 mb-1.5">Privacy</div>
          <div className="text-zinc-700 mb-1.5">Security</div>
          <div className="text-zinc-700 mb-1.5">Terms</div>
        </div>
        {/* Social Links and App Badges */}
        <div className="min-w-[180px] mb-8 flex flex-col items-start">
          <div className="font-bold mb-3 uppercase tracking-wide text-sm">Social Links</div>
        ...
        <div className="flex flex-col gap-4 items-end min-w-[180px] mb-8">
          <div className="flex gap-4">
            <button className="flex items-center gap-2 border border-gray-300 rounded px-4 py-2 bg-white text-gray-700 font-medium">
      ...
      <div className="max-w-[1300px] mx-auto mt-10 border-t border-gray-200 pt-6 text-center text-base text-zinc-700">
